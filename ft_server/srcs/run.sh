...
echo "CREATE USER IF NOT EXISTS 'mtak'@'localhost' IDENTIFIED BY 'mtak';" | mysql -u root --skip-password
echo "GRANT ALL PRIVILEGES ON wordpress.* TO 'mtak'@'localhost' WITH GRANT OPTION;" | mysql -u root --skip-password
